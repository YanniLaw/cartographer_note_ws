...
options = {
  map_builder = MAP_BUILDER,                -- map_builder.lua的配置信息 /cartographer/configuration_files
  trajectory_builder = TRAJECTORY_BUILDER,  -- trajectory_builder.lua的配置信息 /cartographer/configuration_files
  ...
  num_multi_echo_laser_scans = 0,           -- 是否使用multi_echo_laser_scans数据,多重回波单线激光雷达
  num_subdivisions_per_laser_scan = 1,      -- 1帧数据被分成几次处理,一般为1
  num_point_clouds = 1,                     -- 是否使用点云数据，多线激光雷达
